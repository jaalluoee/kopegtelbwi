...
// Contoh Custom Routing (URL) : Dengan mengganti nama class/file .php dengan penamaan pelanggan, 
// maka ditambahkan code dibawah ini :
...
$route['struk_panjar/(:num)'] = 'panjar/struk_panjar';

$route['struk_kembali_panjar/(:num)'] = 'kembali_panjar/struk_kembali_panjar';
