			...
			foreach ($row as $key => $data) { ?>
				<tr>
					...
					<td class="text-center" width="160px">
						<a class="btn btn-default btn-xs" id="set_dtl" 
...
$(document).ready(function() {
	$(document).on('click', '#set_dtl', function() {
		...
		$('#detail').text(detail);
		$('#suppier_name').text(suppliername);
		$('#qty').text(qty);
		$('#date').text(date); //.text untuk menyesuaikan pada bagian atas yang menggunakan tag <span>
	})
})
</script>
