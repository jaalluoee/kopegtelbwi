			...
			<div class="col-md-4 col-md-offset-4">
				<form action="<?=site_url('item/process')?>" method="post">
					<div class="form-group">
						...
						<input type="text" name="barcode" value="<?=$row->barcode?>" class="form-control" placeholder="Enter Barcode" required>
					</div>

					<div class="form-group">
						<label for="product_name">Product Name *</label>
						<input type="text" id="product_name" name="product_name" value="<?=$row->name?>" class="form-control" placeholder="Enter Item Name" required>
					</div>
					...
					<div class="form-group">
						<label>Unit *</label>
						<?php echo form_dropdown('unit', $unit, $selected_unit, 
