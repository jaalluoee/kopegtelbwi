...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>Kopegtel</b>Bwi</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <a href="#">
			...
			<li class="treeview <?=$this->uri->segment(1) == 'stock' || $this->uri->segment(1) == 'sale' ? 'active' : ''?>">
				...
				<!-- <li <?=$this->uri->segment(1) == 'stock_out' ? 'class="active"' : '' ?>><a href="<?=site_url('stock')?>"><i class="fa fa-circle-o"></i> Stock Out</a></li> -->
				</ul>
			</li>

			<li class="treeview <?=$this->uri->segment(1) == 'report' || $this->uri->segment(1) == 'usulan' || $this->uri->segment(1) == 'panjar' || $this->uri->segment(1) == 'kembali_panjar' ? 'active' : ''?>">
				<a href="#">
				...
				<ul class="treeview-menu">
					<li <?=$this->uri->segment(1) == 'usulan' ? 'class="active"' : '' ?>><a href="<?=site_url('usulan')?>"><i class="fa fa-circle-o"></i> Usulan</a></li>
					<li <?=$this->uri->segment(1) == 'panjar' ? 'class="active"' : '' ?>><a href="<?=site_url('panjar')?>"><i class="fa fa-circle-o"></i> Panjar</a></li>
					<li <?=$this->uri->segment(1) == 'kembali_panjar' ? 'class="active"' : '' ?>><a href="<?=site_url('kembali_panjar')?>"><i class="fa fa-circle-o"></i> Kembali Panjar</a></li>
					<li <?=$this->uri->segment(1) == 'penyelesaian' ? 'class="active"' : '' ?>><a href="<?=site_url('penyelesaian')?>"><i class="fa fa-circle-o"></i> Penyelesaian</a></li>
				</ul>
			</li>
			...
			<!-- <li <?=$this->uri->segment(1) == 'pengaturan' ? 'class="active"' : '' ?>>
				<a href="<?=site_url('pengaturan')?>">
					<i class="fa fa-circle"></i> <span>Pengaturan Judul Surat</span>
				</a>
			</li> -->
    </section>
    <!-- /.sidebar -->
