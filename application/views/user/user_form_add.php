			...
			<div class="col-md-4 col-md-offset-4">
				<form action="" method="post">
					...
					<div class="form-group <?=form_error('passconf')? 'has-error' : null?>">
						...
						<input type="password" name="passconf" value="<?=set_value('passconf')?>" class="form-control" placeholder="Enter Password">
						<?=form_error('passconf')?>
					</div>
					...
					<div class="form-group <?=form_error('level')? 'has-error' : null?>">
						...
						<select name="level" class="form-control">
							...
							<option value="2" <?=set_value('level') == 2 ? "selected" : null ?>>Unit</option>
						</select>
						<?=form_error('level')?>
					</div>
